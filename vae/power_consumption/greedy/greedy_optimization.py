...
sys.path.append('../')
import greedy_experiments as vae_experiments
...
if __name__ == '__main__':
    ...
    SEQUENCE_LEN = [20, 40, 60, 80, 140]
    STRIDE = [1, 20, 40, 'window']
    ACTIVATION = [tf.nn.tanh, tf.nn.relu]
    VAE_HIDDEN_SIZE = [2, 3, 5, 7, 10, 15]
    L_RATE_ELBO = [1e-5]
    ...
    print("- normalization: ", new_params[5])
