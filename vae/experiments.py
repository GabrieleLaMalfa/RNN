...
def vae_experiment(data_path,
    ...
    loc = tf.slice(tf.nn.leaky_relu(vae_encoder), [0, 0], [-1, vae_hidden_size])
    ...
    with tf.Session() as sess:
        ...
        fitting_distr = scistats.t(tstud_degrees_of_freedom, mean_elbo, std_elbo,)
        threshold_elbo = (fitting_distr.ppf(sigma_threshold_elbo),
                          fitting_distr.ppf(1.-sigma_threshold_elbo))
