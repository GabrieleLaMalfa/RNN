...
"""
def autocorrelation_function(data, max_lag, plot=False):
    ...
    for i in range(max_lag):
        ...
        autocorrelation[i] = np.correlate(data[:ts_length-i]-mean_data, data[i:]-mean_data)
        autocorrelation[i] /= (ts_length-1)
